...
python post_processing_real_epid.py  --scale --root=./data_real_epid_covid_int --infection_data=./data/RealEpidemics/infected_numbers_covid.csv --inf_threshold=500 --device=cuda:0 --save_file=inferred_coeffs_covid_ts.csv --model_type=GKAN &
sleep 1m
...
sleep 1m
python post_processing_real_epid.py  --scale --root=./data_real_epid_h1n1_int --infection_data=./data/RealEpidemics/infected_numbers_H1N1.csv --inf_threshold=100 --device=cuda:1 --save_file=inferred_coeffs_h1n1_ts.csv --model_type=GKAN &
sleep 1m
...
sleep 1m
python post_processing_real_epid.py  --scale --root=./data_real_epid_sars_int --infection_data=./data/RealEpidemics/infected_numbers_sars.csv --inf_threshold=100 --device=cuda:2 --save_file=inferred_coeffs_sars_ts.csv --model_type=GKAN &
sleep 1m
