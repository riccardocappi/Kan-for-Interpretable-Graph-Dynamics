...
python main.py --config=./configs/config_pred_deriv/config_ic1/config_epidemics.yml --method=optuna --n_trials=25 --study_name=epidemics_gkan_den_true_70db --process_id=0 --denoise --snr_db=70 &
sleep 1m
python main.py --config=./configs/config_pred_deriv/config_ic1/config_epidemics_mpnn.yml --method=optuna --n_trials=25 --study_name=epidemics_mpnn_den_true_70db --process_id=0 --denoise --snr_db=70 &
sleep 1m
python main.py --config=./configs/config_pred_deriv/config_ic1/config_epidemics_llc.yml --method=optuna --n_trials=25 --study_name=epidemics_llc_den_true_70db --process_id=0 --denoise --snr_db=70 &
sleep 1m
python main.py --config=./configs/config_pred_deriv/config_ic1/config_epidemics.yml --method=optuna --n_trials=25 --study_name=epidemics_gkan_den_true_50db --process_id=0 --denoise --snr_db=50 &
sleep 1m
python main.py --config=./configs/config_pred_deriv/config_ic1/config_epidemics_mpnn.yml --method=optuna --n_trials=25 --study_name=epidemics_mpnn_den_true_50db --process_id=0 --denoise --snr_db=50 &
sleep 1m
python main.py --config=./configs/config_pred_deriv/config_ic1/config_epidemics_llc.yml --method=optuna --n_trials=25 --study_name=epidemics_llc_den_true_50db --process_id=0 --denoise --snr_db=50 &
sleep 1m
python main.py --config=./configs/config_pred_deriv/config_ic1/config_epidemics.yml --method=optuna --n_trials=25 --study_name=epidemics_gkan_den_true_20db --process_id=0 --denoise --snr_db=20 &
sleep 1m
python main.py --config=./configs/config_pred_deriv/config_ic1/config_epidemics_mpnn.yml --method=optuna --n_trials=25 --study_name=epidemics_mpnn_den_true_20db --process_id=0 --denoise --snr_db=20 &
sleep 1m
python main.py --config=./configs/config_pred_deriv/config_ic1/config_epidemics_llc.yml --method=optuna --n_trials=25 --study_name=epidemics_llc_den_true_20db --process_id=0 --denoise --snr_db=20 &
sleep 1m
python main.py --config=./configs/config_pred_deriv/config_ic1/config_epidemics.yml --method=optuna --n_trials=35 --study_name=epidemics_gkan_no_fp_true --process_id=0 --deriv_method=finite_diff &
sleep 1m
python main.py --config=./configs/config_pred_deriv/config_ic1/config_epidemics_mpnn.yml --method=optuna --n_trials=35 --study_name=epidemics_mpnn_no_fp_true --process_id=0 --deriv_method=finite_diff &
sleep 1m
python main.py --config=./configs/config_pred_deriv/config_ic1/config_epidemics_llc.yml --method=optuna --n_trials=35 --study_name=epidemics_llc_no_fp_true --process_id=0 --deriv_method=finite_diff &
wait
